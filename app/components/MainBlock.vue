...
.but1::before, .but2::before, .but3::before {
  content: '';
  position: absolute;
  width: 150%;
  height: 150%;
...
/* Внутренний фон — перекрывает центр, оставляя только рамку */
.but1::after, .but2::after, .but3::after {
  content: '';
  position: absolute;
  inset: 2px;
  border-radius: 8px;
